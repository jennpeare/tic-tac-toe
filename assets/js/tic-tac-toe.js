...
(function() {
  var EMPTY, O_PLAYER, TicTacToe, X_PLAYER, game,
  ...
  TicTacToe = (function() {
    ...
    TicTacToe.prototype.checkForWin = function() {
      var winner;
      winner = void 0;
      if ((this.symbols[0] !== EMPTY && this.symbols[0] === this.symbols[1] && this.symbols[0] === this.symbols[2]) || (this.symbols[0] !== EMPTY && this.symbols[0] === this.symbols[3] && this.symbols[0] === this.symbols[6]) || (this.symbols[0] !== EMPTY && this.symbols[0] === this.symbols[4] && this.symbols[0] === this.symbols[8]) || (this.symbols[6] !== EMPTY && this.symbols[6] === this.symbols[7] && this.symbols[0] === this.symbols[8])) {
      ...
      } else if ((this.symbols[1] !== EMPTY && this.symbols[1] === this.symbols[4] && this.symbols[1] === this.symbols[7]) || (this.symbols[3] !== EMPTY && this.symbols[3] === this.symbols[4] && this.symbols[3] === this.symbols[5])) {
